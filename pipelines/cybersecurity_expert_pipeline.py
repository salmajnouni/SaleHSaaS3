"""
Cybersecurity Expert Pipeline v2.1.0
Model: deepseek-r1:7b (chain-of-thought) | VRAM: 4.7GB (GTX 1660 Ti OK)
RAG: cybersecurity_knowledge | Logging: PostgreSQL conversation_logs
"""
...
**الجدول الزمني**: [فوري / قصير المدى / متوسط المدى]"""
    ...
    async def on_startup(self):
        print(f"[Cybersecurity Expert v2.1.0] Model: {self.valves.MODEL_ID}")

    async def on_shutdown(self):
        print("[Cybersecurity Expert v2.1.0] Shutdown")
