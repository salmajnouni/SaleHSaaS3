"""
Financial Expert Pipeline v2.0.0
Model: qwen2.5:7b (general) / deepseek-r1:7b (complex calculations)
VRAM: 4.7GB (GTX 1660 Ti OK)
RAG: financial_knowledge collection
Docs: SOCPA, ZATCA, IFRS, VAT regulations
"""
...
**الإجراء العملي**: [الخطوات التطبيقية]"""
    ...
    async def on_startup(self):
        print(f"[Financial Expert v2.0.0] Model: {self.valves.MODEL_ID}")

    async def on_shutdown(self):
        print("[Financial Expert v2.0.0] Shutdown")
