...
# ─────────────────────────────────────────────────────────────────────────────
"""
Legal Expert Pipeline v2.1.0 — SaleHSaaS
Model: qwen2.5:7b | RAG: saleh_legal_knowledge | Logging: PostgreSQL
"""
...
**ملاحظات**: [تحفظات أو إحالات]"""
    ...
    async def on_startup(self):
        print(f"[Legal Expert v2.1.0] Model: {self.valves.MODEL_ID}")

    async def on_shutdown(self):
        print("[Legal Expert v2.1.0] Shutdown")
