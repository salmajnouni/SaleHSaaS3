"""
title: SaleHSaaS Orchestrator (MCP)
author: SaleHSaaS
version: 1.0.0
description: المنسق الرئيسي — يوجه الطلبات للوكلاء المناسبين
"""
...
class Pipe:
    class Valves(BaseModel):
        n8n_url: str = Field(
            default="http://n8n:5678/webhook/salehsaas-automation-mcp-001",
    ...
    def __init__(self):
        self.type = "pipe"
        self.id = "salehsaas_orchestrator"
        self.name = "SaleHSaaS Orchestrator (MCP)"
