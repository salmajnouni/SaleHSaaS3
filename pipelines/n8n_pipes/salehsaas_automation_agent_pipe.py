...
author: SaleHSaaS
version: 1.0.0
description: وكيل الأتمتة — يبني ويدير workflows في n8n
"""
...
class Pipe:
    class Valves(BaseModel):
        n8n_url: str = Field(
            default="http://n8n:5678/webhook/salehsaas-auto-agent-v2",
    ...
    def __init__(self):
        self.type = "pipe"
        self.id = "salehsaas_automation_agent"
        self.name = "SaleHSaaS Automation Agent"
