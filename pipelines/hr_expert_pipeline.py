"""
HR Expert Pipeline v2.0.0
Model: qwen2.5:7b | VRAM: 4.7GB (GTX 1660 Ti OK)
RAG: hr_knowledge collection
Docs: Saudi Labor Law, GOSI, Nitaqat, HRDF
"""
...
**التوصية العملية**: [الخطوات التطبيقية]"""
    ...
    async def on_startup(self):
        print(f"[HR Expert v2.0.0] Model: {self.valves.MODEL_ID}")

    async def on_shutdown(self):
        print("[HR Expert v2.0.0] Shutdown")
