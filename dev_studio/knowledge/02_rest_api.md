...
> ملاحظة حاكمة: هذا الملف مرجع عام لـ n8n API. لا يُفهم منه وحده أن كل هذه الإمكانيات أو الإعدادات مفعلة في SaleHSaaS الحالية؛ المرجع التشغيلي الحاكم هو `الحقائق التشغيلية الحاكمة - v0.1.md` ثم `docker-compose.yml`.
